...
-- ═══════════════════════════════════════════════════════════════════════
-- לידים והתראות
-- העותק הזה זהה ל-server/sql/leads-and-push.sql, שאותו מריצים ידנית מול
-- Supabase — ‏initDb לא רץ בפרודקשן. שינוי כאן בלי שינוי שם משאיר את
-- הפרודקשן מאחור, וזו בדיוק התקלה שמתועדת למעלה בבלוק ה-backfill.
-- ═══════════════════════════════════════════════════════════════════════
